                        ...
                        <div className='right-content'>
                            ...
                            <div className="refine-search">
                                ...
                                <div className="btn-div-refine-search">
                                    <button className='btn-search'>Deluxe Veggies</button>
                                    <button className='btn-search'>Fresh Veggies</button>
                                    <button className='btn-search'>Margherita</button>
                                    <button className='btn-search'>Peppy Panner</button>
                                    <button className='btn-search'>Veggi Paradies</button>
                                </div>
                            </div>
                            {/* sortby section  */}
