...
const ProductPage = () => {
    const allProducts = [
        ...
        },
        {
            ...
            imgUrl2: "https://www.mahardhi.com/prestashop/MT03/restora/25-home_default/hummingbird-printed-t-shirt.jpg",
            title: "Whiskey King Burger",
            price: "$26",
        },
        {
        ...
        <>
            ...
            <div className="flex-productpage">
                <div className="wid-productpage">
                    <div className="productpage-nav-heading">Top Products</div>
